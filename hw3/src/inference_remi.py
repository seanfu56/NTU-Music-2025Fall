...
def main():
    ...
    cfg = yaml.full_load(open("./config/config_remi.yml", 'r')) 
    ...
    model_path = './ckpt/1_remi.tar'
    output_prefix = 'output/t1/remi_tf/t' + str(args.temperature) + 'p' + str(args.top_p)
    os.makedirs(output_prefix, exist_ok=True)
    
    pretrainCfg = yaml.full_load(open("config/config_remi.yml", 'r'))
